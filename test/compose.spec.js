    ...
    describe('SAFE_Robinson.md', function () {
        it('should parse variable hello World', function (done) {
            ...
            compose(file, null, function (err, ast) {
                ...
                assert.equal(ast.variables[8].variables[0].link.variables[4].key, "Company");
                assert.equal(ast.variables[8].variables[0].link.variables[4].val, "Willem");

                var ycombinator = ast.variables[9];

                assert.equal(ycombinator.variables[0].key, "amount");
                assert.equal(ycombinator.variables[0].link.val, "$50,000");
    ...
    describe('SAFE_Robinson_v2.md', function () {
        it('should parse variable hello World', function (done) {
            ...
            compose(file, null, function (err, ast) {
                ...
                assert.equal(robinson.variables[2].link.val, "$1,000,000");
